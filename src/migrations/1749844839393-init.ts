...
export class Init1749844839393 implements MigrationInterface {
    name = 'Init1749844839393'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "coffee_to_flavor" ADD CONSTRAINT "FK_869e45890ded6cfeb89ea121041" FOREIGN KEY ("flavorId") REFERENCES "coffee"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
